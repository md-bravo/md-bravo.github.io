// Variables
const presupuestoUsuario = 1200 // prompt('Cual es tu presupuesto Semanal?');
...
// Clase de Interfaz
class Interfaz {
    // Inserta los valores iniciales en sus respectivos campos
    ...
    // Imprime un mensaje ya sea de error o exito
